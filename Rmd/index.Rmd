...
See the Support section for instructions on [setting up the R environment](rSetup.html), including Java and RTools. Each package in HADES can be installed independently, but it is also possible to install all HADES packages at once, as described [here](installingHades.html).
