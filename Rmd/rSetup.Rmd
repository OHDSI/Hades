...
1.  Go to <https://cran.r-project.org/bin/macosx/big-sur-arm64/base/>, click on 'R-`r rVersion$rVersion`-arm64.pkg' to download.
...
1.  Go to <https://www.oracle.com/java/technologies/javase/jdk15-archive-downloads.html>, and select the Mac OS installer for your architecture.
