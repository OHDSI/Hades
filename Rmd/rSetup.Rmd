...
1. Go to [https://www.oracle.com/java/technologies/javase-jdk15-downloads.html](https://www.oracle.com/java/technologies/javase-jdk15-downloads.html), and select the Mac OS installer as highlighted below. If you also installed the 32-bit version of R, you *must* also install the other (32-bit) version of Java.
